...
public class Golden_Temple extends AppCompatActivity {
    TextToSpeech t1;
    TextView txt_deatil,txt_Speech;
    Button btn_next,btn_previous,btn_home;
    ImageView imageView,arrow_image,btn_detail;
    int ArrowLenght[]={R.drawable.west,R.drawable.west,R.drawable.turn,R.drawable.north,R.drawable.west,R.drawable.north,R.drawable.blank};
    int Arrow=0;
    int ArrayImage[] = {R.drawable.hanuman,R.drawable.patan_durbar_square,R.drawable.museum,R.drawable.krishna_mandir,R.drawable.lalitpur,R.drawable.handicraft_house,R.drawable.golden_temple};
    int Array[] = {R.id.hanuman,R.id.patan,R.id.museum,R.id.krishna,R.id.lalitpur,R.id.handi,R.id.goldentemple};
    int Text[]={R.id.golden_temple1,R.id.patan_durbar,R.id.museum_gate,R.id.krishna_mandir,R.id.lalitpur_chamber,R.id.handi_craft,R.id.golden_temple};
    int image=0;
    int text=0;
    int array=0 ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Golden_Temple.this.setTitle("Golden Temple");
