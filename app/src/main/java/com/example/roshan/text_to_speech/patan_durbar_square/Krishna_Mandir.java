...
public class Krishna_Mandir extends AppCompatActivity {
    TextToSpeech t1;
    TextView txt_deatil,txt_Speech;
    Button btn_next,btn_previous,btn_home;
    ImageView imageView,arrow_image,btn_detail;
    int ArrowLenght[]={R.drawable.west,R.drawable.west,R.drawable.turn,R.drawable.blank};
    int Arrow=0;
    int ArrayImage[] = {R.drawable.hanuman,R.drawable.patan_durbar_square,R.drawable.museum,R.drawable.krishna_mandir};
    int Array[] = {R.id.hanuman,R.id.patan,R.id.museum,R.id.krishna};
    int Text[]={R.id.krishna_mandir1,R.id.patan_durbar,R.id.museum_gate,R.id.krishna_mandir,};
    int image=0;
    int text=0;
    int array=0 ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Krishna_Mandir.this.setTitle("Krishna Mandir");
