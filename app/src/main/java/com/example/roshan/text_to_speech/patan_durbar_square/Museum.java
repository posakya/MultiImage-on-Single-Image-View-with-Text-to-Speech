...
public class Museum extends AppCompatActivity {
    ...
    int ArrowLenght[]={R.drawable.west,R.drawable.west,R.drawable.blank};
    int Arrow=0;
    int ArrayImage[] = {R.drawable.hanuman,R.drawable.patan_durbar_square,R.drawable.museum};
    int Array[] = {R.id.hanuman,R.id.patan,R.id.museum};
    int Text[]={R.id.museum_gate1,R.id.patan_durbar,R.id.museum_gate};
    int image=0;
    int text=0;
    int array=0 ;
    @Override
